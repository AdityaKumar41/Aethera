...
import { Sun, Briefcase, Shield } from "lucide-react"

const services = [
  {
    icon: Sun,
    title: "Asset Tokenization",
    description: "Convert real-world solar assets into liquid digital tokens on the Stellar blockchain.",
  },
  {
    icon: Briefcase,
    title: "Fractional Investment",
    description: "Enabling fractional ownership of renewable energy projects for global investors.",
  },
  {
    icon: Shield,
    title: "Transparent Yield",
    description: "Automated distribution of revenue from energy production with immutable records.",
  },
]
    ...
    <section id="how-it-works" className="py-32 px-6 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-white/90 leading-relaxed">
                ...
                <p>
                  We empower solar developers with upfront capital and provide investors with transparent,
                  yield-generating assets backed by real-world energy production.
                </p>
              </div>
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-normal mb-6 text-balance font-sans">Empowering Energy Production</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            A decentralized platform to fund, manage, and track solar assets globally with full transparency.
          </p>
        </div>
