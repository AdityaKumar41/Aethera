...
const allTransactions = [
  { name: "Sunnyvale Solar Farm", amount: "+$240.00", category: "Yield distributed", color: "from-amber-400 to-orange-500" },
  { name: "Desert Star Array", amount: "+$185.00", category: "Yield distributed", color: "from-yellow-400 to-amber-500" },
  { name: "Blue Ridge Solar", amount: "+$120.00", category: "Yield distributed", color: "from-emerald-400 to-teal-500" },
  { name: "Canyon Peak Solar", amount: "+$350.00", category: "Yield distributed", color: "from-orange-400 to-red-500" },
  { name: "Horizon Rooftop", amount: "+$75.00", category: "Yield distributed", color: "from-cyan-400 to-blue-500" },
  { name: "Zenith Solar Park", amount: "+$110.00", category: "Yield distributed", color: "from-violet-400 to-purple-500" },
  { name: "Aurora Energy Array", amount: "+$280.00", category: "Yield distributed", color: "from-lime-400 to-green-500" },
  { name: "Solaris Industrial", amount: "+$95.00", category: "Yield distributed", color: "from-fuchsia-400 to-pink-500" },
]
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-normal mb-6 text-balance font-sans">
                Real-world Assets, Real Yield
              </h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Track your solar portfolio performance in real-time with automated yield distribution powered by the
                Stellar blockchain.
              </p>
            </motion.div>
