  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const apiData = {
        ...
        estimatedAnnualProduction: formData.estimatedAnnualProduction ? Number(formData.estimatedAnnualProduction) : undefined,
        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-6">
          <div className="flex items-center gap-3 pb-4 border-b border-border">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Tell us about your solar project</p>
            </div>
          </div>
          ...
          <div className="flex justify-end pt-4 border-t border-border">
            <button
              onClick={() => setStep(2)}
              disabled={!formData.name || !formData.description || !formData.location || !formData.country}
              className="flex items-center gap-2 px-6 py-2.5 bg-foreground text-background rounded-xl font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              Continue
        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-6">
          <div className="flex items-center gap-3 pb-4 border-b border-border">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Specify the technical specifications</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-1.5">Capacity (kW) *</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5">Est. Annual Production (kWh)</label>
                <input
                  type="number"
                  value={formData.estimatedAnnualProduction}
                  onChange={(e) => updateField("estimatedAnnualProduction", e.target.value)}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-1.5">Panel Type</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5">Inverter Type</label>
                <input
                  type="text"
          ...
          <div className="flex justify-between pt-4 border-t border-border">
            <button
              onClick={() => setStep(1)}
              className="px-6 py-2.5 bg-zinc-100 text-foreground rounded-xl font-medium hover:bg-zinc-200 transition-colors"
            >
              Back
            </button>
            <button
        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-6">
          <div className="flex items-center gap-3 pb-4 border-b border-border">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Set your funding and yield parameters</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-xl flex items-start gap-3">
            ...
            <div className="text-sm text-blue-700">
              ...
              <p>Your project will be tokenized. Investors purchase tokens at the price per token you set. They will receive yield proportional to their token holdings.</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-1.5">Funding Target (USD) *</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5">Price Per Token (USD) *</label>
                <input
                  type="number"
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                This is the estimated yield investors can expect. Be realistic to build trust.
              </p>
            </div>

            {formData.fundingTarget && formData.pricePerToken && (
              <div className="p-4 bg-zinc-50 rounded-xl">
                <p className="text-sm text-muted-foreground">Total Tokens to be Issued:</p>
                <p className="text-2xl font-bold">
                  {Math.floor(Number(formData.fundingTarget) / Number(formData.pricePerToken)).toLocaleString()} tokens
                </p>
              </div>
            )}
          </div>
          ...
          <div className="flex justify-between pt-4 border-t border-border">
            ...
            <button
              onClick={() => setStep(4)}
              disabled={!formData.fundingTarget || !formData.pricePerToken || !formData.expectedYield}
              className="flex items-center gap-2 px-6 py-2.5 bg-foreground text-background rounded-xl font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              Review
              <ArrowRight className="w-4 h-4" />
        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-6">
          <div className="flex items-center gap-3 pb-4 border-b border-border">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Review your project details before submitting</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-zinc-50 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">${Number(formData.fundingTarget).toLocaleString()}</p>
                </div>
                <div>
            ...
            <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3">
              ...
              <div className="text-sm text-amber-700">
                ...
                <p>After submission, your project will be reviewed by our team. This typically takes 2-5 business days. You'll be notified once a decision is made.</p>
              </div>
            </div>
