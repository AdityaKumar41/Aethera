        ...
        <div className="flex items-center gap-2">
          <div className="bg-zinc-100 p-1 rounded-xl flex">
            ...
            <button
              ...
              className={cn(
                "px-4 py-2 rounded-lg text-sm font-medium transition-all",
                activeTab === "milestones" ? "bg-white text-purple-600 shadow-sm" : "text-muted-foreground hover:text-foreground"
              )}
            >
              Milestones
            </button>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 bg-white border border-border rounded-xl text-sm focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none w-[200px]"
            />
          </div>
        </div>
      </div>
