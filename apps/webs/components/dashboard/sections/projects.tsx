                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="text-muted-foreground">{project.tokensOwned} tokens</span>
                                        <span className="font-medium">${project.tokenValue.toLocaleString()}</span>
                                    </div>
                                </button>
                            );
                        })
                    ...
                    {!selectedProject ? (
                        <div className="bg-card border border-border rounded-2xl p-12 text-center">
                            ...
                            <p className="text-sm text-muted-foreground mb-4">
                                You don&apos;t have any solar projects yet. Visit the Marketplace to invest in a project.
                            </p>
                        </div>
                    ) : (
                        <>
                            ...
                            <div className="bg-card border border-border rounded-2xl p-6">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold">{selectedProject.tokensOwned}</p>
                                    </div>
                                    <div>
                                        <p className="text-xs text-muted-foreground mb-1">Current Value</p>
                                        <p className="text-lg font-semibold">${selectedProject.tokenValue.toLocaleString()}</p>
                                    </div>
                                    <div>
