  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        ...
        <p className="text-zinc-500 font-medium">Loading pending verifications...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-zinc-900">KYC Verifications</h2>
            ...
            >
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-zinc-900">{user.name || "Anonymous User"}</h4>
