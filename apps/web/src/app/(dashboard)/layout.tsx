...
import { LayoutDashboard, Sun, History, Settings, LogOut, Menu, X } from 'lucide-react';
      ...
      <aside className="hidden md:flex w-72 flex-col fixed inset-y-0 bg-card/20 backdrop-blur-xl border-r border-white/5 z-50">
        <div className="p-8">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="text-2xl font-bold tracking-tighter text-white">Aethera</span>
          </Link>
        </div>
      ...
      <main className="flex-1 md:pl-72 min-h-screen transition-all duration-300">
        ...
        <header className="md:hidden flex items-center justify-between p-4 bg-card/20 backdrop-blur-xl border-b border-white/5 sticky top-0 z-40">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white tracking-tight text-glow">Aethera</span>
          </Link>
        </header>

        <div className="container mx-auto p-6 md:p-12 pb-24">
          {children}
        </div>
      </main>
